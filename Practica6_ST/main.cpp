...
void InsertarMn(vector<Mnemonico> &instrucciones){
    ifstream archivo("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\TABOP.txt", ios::in);
    vector<ModoDir> modos;
    string cadena, modo, cop, cli, instruccion;
    int li, tam;
    unsigned int pos;
    if(archivo.fail())
        cout << "No se encontro el archivo de los mnemonicos en la carpeta del proyecto\nDireccion:\nC:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\TABOP.txt";
    else{
...
void GuardarEt(map<string, string> etiquetas){          //guarda las etiquetas en un archivo
    ofstream archivo;
    archivo.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\TABSIN.txt", ios::out);
...
void GuardarLst(string s){                              //añade al archivo.lst una cadena
    ofstream archivo;
    archivo.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\P6.lst", ios::app);
    archivo<<s;
    archivo.close();
}
...
int main()
{
    ...
    ofstream lst, TABSIN;
    lst.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\P6.lst", ios::trunc);
    lst.close();
    TABSIN.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\TABSIN.txt", ios::trunc);
    TABSIN.close();
    ...
    CL = "0000";
    archivo.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\P6.asm", ios::in);
    if(!archivo.good()){                                         //si el archivo no esta bien
        cout << "No se encontro el archivo o esta dañado\nEn la ruta:\nC:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\P6.asm";
        return 0;
    }
    ...
    else cout << "\n\n\n\n\t\t\t\tTerminado\n\t\t\t\tGuardado en:\nC:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica6_ST\\P6.lst\n\n\n\n\n";
    GuardarEt(etiquetas);
    archivo.close();
    }
    return 0;
