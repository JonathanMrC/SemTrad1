...
void AumentarCL(string &CL, int a){
...
void InsertarMn(vector<Mnemonico> &instrucciones){
    ...
    unsigned int pos;
    archivo.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica3_Directivas\\TABOP.txt", ios::in);
    if(archivo.fail())
        cout << "No se encontro el archivo de los mnemonicos en la carpeta del proyecto\nDireccion:\tC:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica3_Directivas\\TABOP.txt";
    else{
...
void GuardarLst(string s){
    ofstream archivo;
    archivo.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica3_Directivas\\P3.lst", ios::app);
    archivo<<s;
    archivo.close();
}
...
int main()
{
    ...
    archivol.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica3_Directivas\\P3.lst", ios::trunc);
    archivol.close();
    TABSIN.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica3_Directivas\\TABSIN.txt", ios::trunc);
    TABSIN.close();
    ...
    ifstream archivo;
    archivo.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica3_Directivas\\P3.asm", ios::in);
    TABSIN.open("C:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica3_Directivas\\TABSIN.txt", ios::out);

    if(!archivo.good())                                         //si el archivo no esta bien
        cout << "No se encontro el archivo\nEn la ruta:\nC:\\Users\\jonat\\Desktop\\Seminario Traductores\\Practicas\\Practica3_Directivas\\P3.asm";
    else{
                        ...
                        if(instruccion == "ORG"){
                            ...
                            if(operando == " "){
                                ...
                                for(pos = 0; pos < operando.size();++pos){
                                    ...
                                    aumentarhexa8(dos,sdtod(s));
                                    AumentarCL(CL, sdtod(s));
                                    cadena_directiva +=dos +' ';
                                }
                            }
                        }
                            ...
                            if(operando.size() == 0){
                                ...
                                for(pos = 0; pos < operando.size();++pos){
                                    ...
                                    for(;operando[pos] != ',' && pos < operando.size();++pos)
                                        s+=operando[pos];
                                    //falta validar los char
                                    AumentarCL(cuatro,sdtod(s));
                                    AumentarCL(CL, sdtod(s));
                                    cadena_directiva +=cuatro +' ';
                                }
                            }
                        }
